...
import { accessPeriodsEndingOnDay, endOfDayUtc, startOfDayUtc } from './access-periods'
...
describe('access period day bounds', () => {
  ...
  it('builds inclusive access periods for an invitation departure day', () => {
    const periods = accessPeriodsEndingOnDay(['CONGES', 'CORELAB'], '2026-09-15')
